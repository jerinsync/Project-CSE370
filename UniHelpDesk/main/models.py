...
class Course_Content(models.Model):
    ...
    course_content_tag = models.TextField(max_length=5000, blank=True, null=True)
    course_content_description = models.TextField(max_length=5000, blank=True, null=True)
